...
/// Uses an `AccountDetailRepositoryType` service to retrieve data and maps it to lightweight `Transaction` items.
class TransactionDetailsViewModel: ObservableObject {
    ...
    /// - Parameter service: Repository used to fetch account details. Defaults to a concrete implementation.
